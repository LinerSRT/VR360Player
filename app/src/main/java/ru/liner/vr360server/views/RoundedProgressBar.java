...
public class RoundedProgressBar extends ProgressBar {
    public RoundedProgressBar(@NonNull Context context) {
        super(context);
    }

    public RoundedProgressBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundedProgressBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
